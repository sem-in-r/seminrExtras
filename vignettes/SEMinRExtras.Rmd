...
`assess_nca()` wraps the NCA R package for seamless use with seminr models. It auto-detects direct predictors from the structural model and runs ceiling-based NCA analysis.
